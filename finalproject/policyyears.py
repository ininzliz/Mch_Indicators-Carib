...
from datarangle import mch_95,mch_05,mch_15
...
def extract_3_cols(df, col1, col2, col3):
    return df[[col1, col2, col3]]

NeoMR95 = extract_3_cols(mch_95, "Country", "Neonat_MR", "PolicyCount")
...
# Call the function
plot_strip_subplots(NeoMR95,["Neonat_MR"])
